        ...
        for point in points:
            ...
            try:
                ...
                x = (transform.transform.translation.x + 
                     point_stamped.pose.position.x * np.cos(transform.transform.rotation.z) -
                     point_stamped.pose.position.y * np.sin(transform.transform.rotation.z))
                y = (transform.transform.translation.y + 
                     point_stamped.pose.position.x * np.sin(transform.transform.rotation.z) +
                     point_stamped.pose.position.y * np.cos(transform.transform.rotation.z))
